...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-w$g+rcc$u(yp4wh@&1@w8y(#&!*!-f)k_=8!t7u-9y06m5-+ym')
...
# WhiteNoise storage settings for production compression and caching
STORAGES = {
    "default": {
